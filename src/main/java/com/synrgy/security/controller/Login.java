...
//import com.synrgy.security.service.impl.UserAuthServiceImpl;
...
//
//    @Autowired
//    public UserAuthServiceImpl serviceReq;
//
...
//        {
//            return new ResponseEntity<Map>(response.templateError(e.getDetails()), HttpStatus.BAD_GATEWAY);
//        }
